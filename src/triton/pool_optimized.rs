...
impl OptimizedConnectionPool {
    ...
    pub async fn new(triton_endpoint: &str, config: OptimizedPoolConfig) -> Result<Arc<Self>> {
    ...
    async fn prewarm(&self) -> Result<()> {
        ...
        self.stats
            .current_pool_size
            .store(created_count as u32, Ordering::Relaxed);
        self.stats
            .total_created
            .store(created_count as u64, Ordering::Relaxed);
